...
ach2.account_name,
max(case when perv_pf_pa_decline.sender_id is not null then 1 else 0 end) as flag_if_declined_p2p
from ato_final af
...
left join perv_pf_pa_decline on af.user_id = perv_pf_pa_decline.sender_id and perv_pf_pa_decline.SENT_AT >= af.ATO_TS and perv_pf_pa_decline.SENT_AT <= af.TRANSACTION_TIMESTAMP
